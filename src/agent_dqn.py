...
class ChessQNetwork(nn.Module):
    ...
    def __init__(self, input_channels: int = 15, hidden_dim: int = 512):
        ...
        Args:
            input_channels (int): Number of input channels (default: 15)
            hidden_dim (int): Dimension of the hidden layers (default: 512)
        """
        super().__init__()
    ...
    def _make_res_block(self, channels):
        ...
        Args:
            channels (int): Number of channels in the residual block.
        Returns:
            nn.Sequential: The constructed residual block.
        """
...
class BulletExperienceReplay:
    ...
    This buffer stores experiences with time pressure weighting to improve learning efficiency.
    It uses a circular buffer to manage memory efficiently.
    """
    ...
    def push(self, state, action, reward, next_state, done, time_pressure_level):
        ...
        Args:
            ...
            time_pressure_level: The level of time pressure during the action.
        """
...
class BulletChessDQNAgent:
    ...
    def __init__(self,
        ...
        Args:
            ...
            epsilon_decay (float): Exploration decay factor.
    ...
    def train_step(self) -> float:
        ...
        Returns:
            float: The loss value from the training step.
        """
    ...
    def update_target_network(self):
        ...
        This method updates the target network with the weights from the main Q-network.
        """
    ...
    def save(self, filepath: str):
        ...
        Args:
            filepath (str): Path to save the model and training state.
        """
        torch.save({
    ...
    def load(self, filepath: str):
        ...
        Args:
            filepath (str): Path to load the model and training state.
        """
    ...
    def set_eval_mode(self):
        ...
        This method disables dropout and batch normalization updates for inference.
        """
    ...
    def set_train_mode(self):
        ...
        This method enables dropout and batch normalization updates for training.
        """
